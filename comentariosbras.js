    ...
    document.getElementById("tituloCapitulo").textContent = "Anotações - Capítulo " + capitulo;

    let anotacoes = JSON.parse(localStorage.getItem("anotacoes_capitulo_" + capitulo)) || [];
    ...
    function salvarAnotacao() {
        ...
        if (texto) {
            ...
            localStorage.setItem("anotacoes_capitulo_" + capitulo, JSON.stringify(anotacoes));
    ...
    function voltar() {
    window.location.href = "brascubas.html";
}
